...
printPizza(pizza);
var url = "https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/consistent-type-imports.md";
const pizzaName = pizza
.name.
split(" ")
if (pizzaName) pizzaName.forEach(function(i) {console.log(i)}); else { console.log("no pizza name"); console.log("anything else?");}